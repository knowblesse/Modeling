function [negativeloglikelihood, V, alpha, SimulationResult, ExperimentResult, Model_element_number] = computeNLL_LePelly(X, schedule, model, num_repeat, ExperimentData, value)
%% computeNLL_LePelly
