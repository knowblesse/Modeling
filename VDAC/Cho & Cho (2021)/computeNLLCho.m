...
for i = 1 : 2
    ...
    negativeloglikelihood = negativeloglikelihood - (...
        sum(log(normpdf(X(1)*(reshape(SimulationResult.UncertaintyDistractor.Result{i}, [], 1)+X(2)), ExperimentData.UncertaintyDistractor.Mean(i), ExperimentData.CertaintyDistractor.SD))) + ...
