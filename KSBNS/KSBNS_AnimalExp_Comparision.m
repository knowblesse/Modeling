...
%% Run
for model = 1:5
    app1 = CCC_exported(schedule_con_1,model,[0.5,0.5,0.5]);
    app2 = CCC_exported(schedule_con_2,model,[0.5,0.5,0.5]);
    app3 = CCC_exported(schedule_par_1,model,[0.5,0.5,0.5]);
    app4 = CCC_exported(schedule_par_2,model,[0.5,0.5,0.5]);
    fig = figure(model);
    clf(fig);
    hold on;
