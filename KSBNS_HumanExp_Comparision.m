...
schedule_exp1_uncertain = repmat([...
    ...
    1,0,0,0,0.5,0.5,0.5,0;...
    1,0,0,0,0.5,0.5,0.5,0;...
    1,0,0,0,0.5,0.5,0.5,0;...
    ],25,1);
schedule_exp1_certain = repmat([...
    1,0,0,1,0.5,0.5,0.5,0.25;...
    ],100,1);

schedule_exp2_uncertain = repmat([...
    1,0,0,1,0.5,0.5,0.5,0.9;...
    1,0,0,1,0.5,0.5,0.5,0.75;...
    1,0,0,1,0.5,0.5,0.5,0.25;...
    1,0,0,1,0.5,0.5,0.5,0.1;...
    ],25,1);
...
for model = 1:5
    ...
    for r = 1 : num_repeat
        ...
        schedule_exp1_uncertain_shuffled = [shuffle1D(schedule_exp1_uncertain);repmat([1,0,0,0,0.5,0.5,0.5,0],50,1)];
        schedule_exp1_certain_shuffled = [shuffle1D(schedule_exp1_certain);repmat([1,0,0,0,0.5,0.5,0.5,0],50,1)];
        schedule_exp2_uncertain_shuffled = [shuffle1D(schedule_exp2_uncertain);repmat([1,0,0,0,0.5,0.5,0.5,0],50,1)];
        schedule_exp2_certain_shuffled = [shuffle1D(schedule_exp2_certain);repmat([1,0,0,0,0.5,0.5,0.5,0],50,1)];

        app1 = CCC_exported(schedule_exp1_uncertain_shuffled,model);
        app2 = CCC_exported(schedule_exp1_certain_shuffled,model);
        app3 = CCC_exported(schedule_exp2_uncertain_shuffled,model);
        app4 = CCC_exported(schedule_exp2_certain_shuffled,model);
